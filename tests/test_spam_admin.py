...
#
# """
#     things to test for comments:
#     1) spam assassin determines comment is spam         DONE
#     2) spam assassin does not consider comment is spam  DONE
#     3) train spam assassin (HAM, SPAM)                  DONE
#     4) num flags is large enough so comment marked as spam DONE
#     5) spam admin says comment is spam so comment is deleted  DONE
#     6) spam admin says comment is not so comment is not deleted DONE
#     7) comment's spam status is always UNKOWN if SPAM_ADMIN=False DONE
# """
#
#
#
